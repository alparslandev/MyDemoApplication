...
public class Resource<T> {
    ...
    public Resource(int status, @Nullable Integer errorType, String msg, Throwable throwable) {
        this.status = status;
        this.errorType = errorType;
        this.message = msg;
    ...
    public static <T> Resource<T> error(String msg, @Nullable Integer errorType, Throwable throwable) {
        return new Resource<>(ERROR, errorType, msg, throwable);
    }
